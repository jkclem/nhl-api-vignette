...
Now let's look at some stats for the total history of all teams who have played. Note that some of these teams belong to the same franchise. I treat teams that belong to the same franchise as separate (e.g. the Colorado Rockies and the New Jersey Devils). I called `nhlAPI("teamTotals")` to get this data.
